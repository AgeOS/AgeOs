            ...
            <div className='quadrado_download'>
                ...
                <div className='ageOS_informacoes'>
                    ...
                    <div className='informacoes'>
                        <p><span>Data da versão:</span> 16-08-2024</p>
                        <p><span>Tamanho do sistema:</span> 103.06 MB</p>
                    </div>
                </div>
                ...
                <div className='ageOS_informacoes2'>
                    ...
                    <div className='aviso'>
                        <p>AgeOS Premium existe a opção  de acesso antecipado onde pode ocorrer a liberação ARM X86.</p>
                    </div>
                </div>
            </div>
        </section>
