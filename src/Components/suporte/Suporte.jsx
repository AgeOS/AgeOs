        ...
        <section className="container_canal">
          ...
          <div className="atencao">
            <div className="container">
              <img className="whats-img" src={whats} alt="" />
              <p>
                Assistência por meio do nosso canal no WhatsApp, para ajudar
                você com dúvidas, orientações ou qualquer suporte técnico.
              </p>
              <button className="botao_contato">
                <a
                  href="https://wa.me//5511911054439?text=Olá%20Preciso%20De%20Ajuda%20Com%20a%20AgeOS"
                  target="_blank"
                >
                  <p>Clique Aqui</p>
                </a>
            ...
            <div className="container">
              ...
              <p>
                Atendimento por e-mail para ajudar você com dúvidas, orientações
                ou qualquer suporte técnico que precisar.
              </p>
              <button className="botao_contato">
                <a
                  href="mailto:ageosproa@gmail.com?subject=Suporte%20AgeOS&body=Olá,%20preciso%20de%20ajuda%20com%20a%20AgeOS."
          ...
          <div className="chatbot">
            <div className="dentro_chatbot">
              <h1>
                ...
                com nosso ChatBot <span className="Bold">AgeBot</span>
              </h1>
            </div>
        ...
        <section className="container_duvidas">
          ...
          <section className="section-c">
            <div className="containerr">
              ...
              >
                <p>
                  Não! O AgeOS pode ser instalado em qualquer dispositivo
                  Android, oferecendo uma solução acessível e eficiente sem a
                  necessidade de trocar de aparalho.
                </p>
              </div>
              ...
              >
                <p>
                  O AgeOS possui um identificador de chamadas que alerta sobre
                  números suspeitos e evita fraudes telefônicas, além de
                  proteção nativa que dispensa antivírus externo.
                </p>
              </div>
              ...
              >
                <p>
                  Sim! As atualizações são recorrentes, garantindo que o sistema
                  esteja sempre protegido e funcionando com os recursos mais
                  recentes.
                </p>
              </div>
              ...
              >
                <p>
                  Oferecemos suporte dedicado para resolver qualquer dúvida ou
                  problema técnico, com atendimento de longa duração conforme
                  seu plano. Além disso, contamos com um fórum onde usuários
                  podem compartilhar dúvidas e apoiar outras famílias.
                </p>
              </div>
            </div>
          </section>
